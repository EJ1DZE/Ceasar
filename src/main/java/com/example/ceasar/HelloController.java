...
public class HelloController {
    ...
    public void SetInputFile(ActionEvent actionEvent) {
        inputFile.setText(FileChooser());
    }

    public void SetOutputFile(ActionEvent actionEvent) {
        outputFile.setText(FileChooser());
    }
